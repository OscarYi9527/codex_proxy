...
function usageWindowHtml(win){
  if(!win||win.used_percent==null)return '<span class="cell-sub">暂无额度数据</span>'
...
function renderSettings(){
  ...
  const info=`<div class="card-body"><div class="provider-row" style="grid-template-columns:1fr auto"><span class="cell-sub">网关版本</span><b>2.0.0</b></div><div class="provider-row" style="grid-template-columns:1fr auto"><span class="cell-sub">管理 API</span><code>/admin/api</code></div><div class="provider-row" style="grid-template-columns:1fr auto"><span class="cell-sub">配置热重载</span><span class="badge">已启用</span></div><div class="provider-row" style="grid-template-columns:1fr auto"><span class="cell-sub">数据存储</span><span>本地 JSON</span></div></div>`
