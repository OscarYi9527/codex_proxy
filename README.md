...
Windows 同事端另提供可直接运行的安装、DPAPI Key 保护、Tailscale/模型目录诊断、Key
轮换和安全卸载脚本。Codex 通过 command-backed auth 按需读取 Key，Key 不写入
`config.toml`、环境变量或命令参数。用法及 GitHub 开源项目参考审计见
[`docs/WINDOWS_RK3588_CLIENT.md`](docs/WINDOWS_RK3588_CLIENT.md)。
