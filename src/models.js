...
import { proxyConfig, PROXY_DATA_DIR, getRelay } from './config.js'

const THREAD_ROUTES_DIR = process.env.CODEX_PROXY_THREAD_ROUTES_DIR || path.join(PROXY_DATA_DIR, 'codex-thread-routes')
